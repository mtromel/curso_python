...
confidenciais em seu código ou em repositórios de código compartilhados, pois o
arquivo .env pode ser adicionado ao .gitignore para não ser incluído nos
