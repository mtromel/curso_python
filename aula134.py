...
A associção não especifica como um objeto controla o ciclo de vida de outro objeto.
'''
class Escritor:
...
escritor.ferramenta = maquina_de_escrever # aqui estou fazendo uma associação
qual_esta_em_uso = escritor.ferramenta.escrever()
print(qual_esta_em_uso)
