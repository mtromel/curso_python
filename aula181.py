...
mas na verdade não são. Portanto, este módulo não deve ser usado para segurança
ou uso criptográfico. O motivo disso é que quanto temos uma mesma entrada e um
mesmo algorítimo, a saída pode ser previsível.
...
# Funções:
# seed
#     -> inicializa o gerador random (por isso "números pseudoaleatórios)
# se não for informado o Python usa os microsegundos da hora do computador
# random.seed()
