...
As regras para classes abstratas com métodos abastratos é que elas NÃO PODEM ser instanciadas diretamente.
...
É possível criar @property @setter @classmethod @staticmethod e @method como astratos. Para isso use @abstractmethod
    como decorador mais interno.
'''
