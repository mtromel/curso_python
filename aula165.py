'''
video aula 278
Maria pegou um emprestimo de 1.000.000 para realizar o pagamento em 5 anos.
A data em que ela pegou o emprestimo foi 20/12/2020 e o vencimento de cada
...
for data in data_parcelas:
    print('Vencimento: ', data.strftime('%d/%m/%Y'),
